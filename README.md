...
收到 Bilibili、YouTube、Twitter/X、TikTok、抖音等视频平台链接或 QQ 小程序卡片时，插件会自动解析媒体信息并回复。
...
B 站自动回复会包含标题、类型、UP、播放、弹幕、收藏、点赞、硬币、评论和简介。其他平台会包含标题、作者、时长、简介和最佳流信息。普通消息不会自动下载视频，只有明确使用 `/下载` 或 `/视频` 时才会下载。
